...
def test_catalog_includes_tpu_v4(all_products):
    ...
    assert google_skus == ["google_coral_edge_tpu", "google_tpu_edge_pro", "google_tpu_v1", "google_tpu_v3", "google_tpu_v4", "google_tpu_v5p"]
...
def test_other_vendors_unaffected_by_tpu_v4_addition(all_products):
    ...
    assert counts_by_vendor.get("google") == 6  # +google_tpu_edge_pro (sprint #72 PR 6, closes sprint)
